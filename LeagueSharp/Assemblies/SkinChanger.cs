    ...
    internal class SkinChanger {
        ...
        public class Skin {
            ...
            public struct Struct {
                ...
                public readonly byte SourceNetworkIdP1;
                public readonly byte SourceNetworkIdP2;
                public readonly byte SourceNetworkIdP3;
                public readonly byte SourceNetworkIdP4;
                public readonly byte Unknown;
                public readonly byte[] Unknown2;
                public readonly byte[] Unknown3;

                public Struct(String charName, int sourceNetworkId = 0, int skinId = 0) {
                    SourceNetworkId = sourceNetworkId == 0 ? ObjectManager.Player.NetworkId : sourceNetworkId;
                    SkinId = skinId;
